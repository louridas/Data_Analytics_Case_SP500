...
*Interactive chart:* Put the mouse on the plot to see daily values, and zoom with click-and-drag with the mouse in the smaller graph below. 
...
int_market <- nvd3Plot(ReturnsSoFar ~ TheDate, data = data.frame.market, id = 'chart', type = 'lineChart', height=200)
