...
And this is an *Interactive chart:* (if you put the mouse on the plot you can see daily values. You can also zoom in the graph using the smaller graph below)
